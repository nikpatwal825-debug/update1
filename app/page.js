...
export default function Home() {
  ...
  return (
    <div className="bg-heritage-cream" data-page="home">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          <motion.button 
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="bg-green-600 hover:bg-green-700 text-white px-12 py-4 rounded-sm text-lg font-light transition-all duration-300 shadow-lg hover:shadow-2xl border border-green-600 flex items-center gap-3 mx-auto"
            style={{ fontFamily: language === 'hi' ? 'Noto Serif Devanagari, serif' : 'inherit' }}
            data-donate-btn
          >
